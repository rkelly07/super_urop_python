...
class CoresetStructure:
	...
	def get_video_info(self):
		return self.coreset['video_info'][0][0][0]
	
	def get_tree_name(self):
		return self.coreset['coreset_name'][0][0][0]

	def get_results_name(self):
		return self.coreset['coreset_results'][0][0][0]
	...
	def get_importance(self, node_num):
		return sum(self.coreset['Nodes'][0][0][0][node_num-1]['Importance'][0])
	
	def get_importance_keyframes(self, node_num):
		return self.coreset['Nodes'][0][0][0][node_num-1]['Importance'][0]
